/*1. Logica de estados:
     ...
     -Pantallas de credito
  2. Programando integramente con POO y que incluya almenos un arreglo de objetos
  3. Comunicacion entre clases a travez de sus metodos
  4. Implementacion de alguna libreria de sonido*/
...
void draw (){
 ...
 if (Perdedor == true){
   ...
   rect (0, 10, 140, 40);
   fill (230, 200, 200);
   text ("Score:  "+ posX.size(), 10, 10, width -20, 50);
   }
 }
